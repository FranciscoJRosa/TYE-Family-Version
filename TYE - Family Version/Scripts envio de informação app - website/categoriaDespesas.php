...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $catID_App = $_POST['catID_App'];
	$designacao = $_POST['designacao'];
  $userCode = $_POST['userCode'];

	//creating a statement to insert to database
	$stmt = $conn->prepare("INSERT INTO categoriadespesa (catID_App, designacao, userCode) VALUES (?, ?, ?)");

	//binding the parameter to statement
	$stmt->bind_param("sss", $catID_App, $designacao, $userCode);

...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $catRendID_App = $_POST['catRendID_App'];
	$designacao = $_POST['designacao'];
  $userCode = $_POST['userCode'];

	//creating a statement to insert to database
	$stmt = $conn->prepare("INSERT INTO categoriarendimento (catRendID_App, designacao, userCode) VALUES (?, ?, ?)");

	//binding the parameter to statement
	$stmt->bind_param("sss", $catRendID_App, $designacao, $userCode);

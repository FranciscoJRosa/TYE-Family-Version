...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $username = $_POST['username'];
	...
	$stmt = $conn->prepare("INSERT INTO registodespesas (despID_App, designacao, valor, data, categoria, userCode, username) VALUES (?, ?, ?, ?, ?, ?, ?)");

	//binding the parameter to statement
	$stmt->bind_param("sssssss", $despID, $designacao, $valor, $data, $categoria, $userCode, $username);
